...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { ColorSceneType, ColorType, SystemColors, Colors } from './src/utils/colord'
  import('./src/utils/colord')
  // @ts-ignore
  export type { ECOption } from './src/utils/echarts'
  import('./src/utils/echarts')
  // @ts-ignore
  export type { DeployReload, DeployReload } from './src/utils/reload'
  import('./src/utils/reload')
  // @ts-ignore
  export type { RouteMenuStore } from './src/store/route-menu'
  import('./src/store/route-menu')
}
